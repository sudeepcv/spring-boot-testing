...
import com.sudeepcv.integration.AbstractContainerBaseTest;
...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)  // remove this line to use h2  database
@Testcontainers
